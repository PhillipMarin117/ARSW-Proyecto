...
const app = express();
//app.use(express.static("src/main/resourses/static/js/public"));
...
app.get("/au", functithon(req, res) {
  ...
  realtime.auth.createTokenRequest(tokenParams, function (err, tokenRequest) {
    if (err) {
      ...
      console.log("Entra en el if despues del error");
    } else {
...
function startGameTick() {
  //console.log("Esta entrand en StrattGameTick")
